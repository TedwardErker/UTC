...
#+BEGIN_SRC R
    ...
    classify.segmented.raster <- function(segment.feature.df.dir,
        ...
        path <- paste0(dd.accuracy.classified.dir,"/",tile.name,"_",segmentation.prms,"_",mod$task.desc$id,"_",tuning,"_",mod$learner$id,".tif")
    ...
    classify.pixel.raster <- function(tile.dir = dd.accuracy.dir,
        ...
        path <- paste0(dd.accuracy.classified.dir,"/",tile.name,"_",seg.prms,"_",pix.mod$task.desc$id,"_",tuning,"_",pix.mod$learner$id,".tif")
