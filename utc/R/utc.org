...
#+begin_src R
    ...
    segment  <- function(image.dir,
          ...
          system(paste0("cd ",image.dir,";", "python ../../code/fia_segment_cmdArgs.py ",pixel_size," ",segment_size," ",compactness," ",image.name))
  }
...
: "
:                        pixel.size,"
: Error: object 'compactness' not found
: Error: unexpected '}' in "}"
