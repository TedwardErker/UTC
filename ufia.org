...
#+BEGIN_SRC R
  ...
  image.dir.path <- paste0(urban.area.dir.path)
...
#+BEGIN_SRC R
  ...
  image <- stack(paste0(image.rd.directory, image.name))
...
*** Segment image
I need to make this run properly from this document.  Also need to
change code to take arguments
#+BEGIN_SRC sh
