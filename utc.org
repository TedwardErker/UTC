...
#+BEGIN_SRC R
  ...
  writeRaster(x = out, filename = paste0(urb.path,"ClassifiedUrbanArea.tif"), overwrite = T, datatype = 'INT1U')
  ...
  writeRaster(x = out, filename = paste0(urb.path,"rgbn.tif"), overwrite = T)
