...
In dir.create(dd.accuracy.classified.dir) :
  cannot create dir '../DD/Accuracy/ClassifiedTiles', reason 'No such file or directory'
[[1]]
[1] TRUE
[[1]]
[1] TRUE
...
#+BEGIN_SRC R
  ...
  pts.on.classified.tile.plot(pts, classified.tile)
  ...
  pts.on.classified.tile.plot <- function(pts, classified.tile) {
