...
'data.frame':	286 obs. of  12 variables:
 $ pct_g_pred            : num  0.22378 0.0932 0.41865 0.60445 0.00117 ...
 $ pct_t_pred            : num  0.776 0.795 0.49 NA 0.048 ...
 $ grid.tile.target.model: chr  "madisonNAIP.mad.100m.1_N-30_C-15_madisonNAIP_all_Untuned_rf_prob.tif" "madisonNAIP.mad.100m.10_N-30_C-15_madisonNAIP_all_Untuned_rf_prob.tif" "madisonNAIP.mad.100m.11_N-30_C-15_madisonNAIP_all_Untuned_rf_prob.tif" "madisonNAIP.mad.100m.12_N-30_C-15_madisonNAIP_all_Untuned_rf_prob.tif" ...
...
#+results:
#+begin_example
'data.frame':	286 obs. of  20 variables:
 $ pct_g_pred            : num  0.22378 0.0932 0.41865 0.60445 0.00117 ...
 $ pct_t_pred            : num  0.776 0.795 0.49 NA 0.048 ...
 $ grid.tile.target.model: chr  "madisonNAIP.mad.100m.1_N-30_C-15_madisonNAIP_all_Untuned_rf_prob.tif" "madisonNAIP.mad.100m.10_N-30_C-15_madisonNAIP_all_Untuned_rf_prob.tif" "madisonNAIP.mad.100m.11_N-30_C-15_madisonNAIP_all_Untuned_rf_prob.tif" "madisonNAIP.mad.100m.12_N-30_C-15_madisonNAIP_all_Untuned_rf_prob.tif" ...
 $ grid                  : chr  "mad.100m.1" "mad.100m.10" "mad.100m.11" "mad.100m.12" ...
 ...
 $ pct.g.googleEarth     : num  0.23 0.14 0.55 0.58 0 0.37 0.97 0.15 0.65 0.24 ...
 $ pct.i.googleEarth     : num  0 0.18 0.08 0.42 0.92 0.03 0 0.58 0.21 0.27 ...
 $ pct.t.googleEarth     : num  0.71 0.68 0.37 0 0.08 0.6 0.03 0.27 0.14 0.49 ...
 $ target.type.y         : chr  "multinomial" "multinomial" "multinomial" "multinomial" ...
 $ target.cover.y        : chr  "all" "all" "all" "all" ...
 $ pct.o.googleEarth     : num  0.06 0 0 0 0 0 0 0 0 0 ...
#+end_example
...
#+BEGIN_SRC R
  error_tree <- grid.master.df %>%
      ...
      mutate(segment.size = ifelse(seg.params == "Pixel",1,seg.params),
             segment.size = as.numeric(str_match(seg.params, "N-([0-9]*)_.*")[,2]))
...
1 madisonNAIP rf_prob      225  N-30_C-15  mad.150m.7 0.3079507
2 madisonNAIP rf_prob      225  N-30_C-15 mad.100m.20 0.2133701
3 madisonNAIP rf_prob      225  N-30_C-15  mad.150m.6 0.1853430
4 madisonNAIP rf_prob      225  N-30_C-15  mad.100m.6 0.1567663
5 madisonNAIP rf_prob      225  N-30_C-15  mad.100m.7 0.1351723
6 madisonNAIP rf_prob      225  N-30_C-15 mad.100m.19 0.1019457
...
******** errors
#+begin_src R :exports results :results graphics :file ./figs/error_distributions.png :width 200
...
******** absolute errors
#+begin_src R :exports results :results graphics :file ./figs/abs_error_distributions.png :width 200
...
#+BEGIN_SRC R
  ...
  ## ifelse(!is.na(str_extract(seg.params, ".*105.*")), 105,
...
#+BEGIN_SRC R :results graphics :file figs/MAE_tree_compare_n.ptsXMAE.png :height 400 :width 400
  ggplot(MAE_tree, aes(x = grid.row.col.num, y = MAE_t, color = model, size = n.points)) + geom_point() +
...
#+BEGIN_SRC R :results graphics :file figs/MAE_tree_compare_AreaXMAE_NAIP_seg60.png
  ...
  ggplot(MAE_tree.sub, aes(x = area_meters_squared, y = MAE_t), color = "blue") + geom_point() +
...
#+results:
[[file:figs/MAE_tree_compare_AreaXMAE_NAIP_seg60.png]]


#+BEGIN_SRC R :results graphics :file figs/MAE_tree_compare_seg.sizeXMAE.png :height 800 :width 600

  ggplot(MAE_tree, aes(x = segment.size, y = MAE_t, color = n.points, group = interaction(n.points,target.type))) + geom_line() +
