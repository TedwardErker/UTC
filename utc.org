...
#+BEGIN_SRC R
  ...
  urban.dir <- "../RD_US_UrbanAreasShapefile"
  urban.and.incorporated.dir <- "../RD_merged_WIurbanAreas_and_incorporatedAreas"
dir.list <- list(whole.state.rd,   whole.state.rd.accuracy, whole.state.dd.naip, whole.state.rd.training.regions, whole.state.dd,   whole.state.dd.training,  whole.state.dd.accuracy,  naip.tile.dir,   naip.seamlines.dir,  crop.dir,   water.dir,   urban.dir,   urban.and.incorporated.dir,   whole.state.dd.models)
...
#+results:
: Error: object 'pca.dir' not found
: Error: object 'training.dir' not found
: Error: object 'grids.accuracy.dir' not found
: Error: object 'fieldplots.accuracy.dir' not found
: Error: object 'points.accuracy.dir' not found
: Error: object 'grid.accuracy.region.dsn' not found
...
: [2] "city-NewRichmond_month-8_hour-10_solElv-45_azimuth-113_NAIP_Training"
...
#+begin_src R
  ...
  segment.param.sets <- model.building.rdss %>%
    ...
    foreach(segment.param.set = segment.param.sets) %do% {
...
#+begin_example
 Standard deviations:
[1] 2.58139410 1.33561361 0.59075132 0.36984938 0.20607976 0.13723929 0.06344297
[8] 0.02876257 0.02468428

Rotation:
                   PC1         PC2        PC3          PC4         PC5
blue         0.3546051  0.27044473 -0.2267699 -0.257275326  0.30855947
green        0.3213313  0.41123540 -0.0836651  0.155842652  0.21923757
ndvi        -0.3674691  0.20261643  0.1438044  0.100523044  0.40567858
nir         -0.1906729  0.62227910 -0.3741382 -0.066674996 -0.63177242
ratio.blue   0.3700304 -0.02315896  0.1892698 -0.724621759 -0.08662387
ratio.green  0.3006207  0.34781510  0.6729285  0.405785072 -0.16760495
ratio.nir   -0.3817914  0.09363262 -0.1604289 -0.005347916  0.22887281
ratio.red    0.3018217 -0.43531884 -0.2910827  0.362021298 -0.32409109
red          0.3680427  0.09838274 -0.4263731  0.272297262  0.31623019
                    PC6         PC7          PC8          PC9
blue        -0.04041485  0.13238011 -0.751904779 -0.061417418
green       -0.20124545  0.61511590  0.476398612  0.049566484
ndvi         0.77264041  0.17616187 -0.021467776 -0.009290331
nir          0.16994733 -0.06196827 -0.009212816 -0.006647981
ratio.blue   0.31357070 -0.06775461  0.264246633  0.348416672
ratio.green  0.00569249 -0.20417027 -0.200171603  0.247547003
ratio.nir   -0.27200565 -0.06872491 -0.067280024  0.827092878
ratio.red    0.35718107  0.33889115 -0.171909627  0.355807751
red          0.17912909 -0.63512861  0.251323198  0.016884277
#+end_example
...
#+begin_src R
  ...
  box <- gBuffer(pts, width = buffer.size, )
...
#+results:
:  Error in { :
:   task 12 failed - "task 11 failed - "Cannot create a RasterLayer object from this file. (file does not exist)""
...
**** TODO Classify Tiles at accuracy regions
